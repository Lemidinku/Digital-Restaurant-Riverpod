...
// in restaurant/test/unit_test/repository_test/order_repository_test.dart.
...
import 'package:restaurant/storage.dart' as _i7;
...
class MockSecureStorage extends _i1.Mock implements _i7.SecureStorage {
  ...
  @override
  _i3.Future<String?> read(dynamic key) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [key],
        ),
